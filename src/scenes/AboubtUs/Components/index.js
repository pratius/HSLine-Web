            ...
            <div className="relative overflow-hidden hero-black" >
                ...
                <div className=" mx-auto p-6 md:pt-12 sm:p-8 h-full flex flex-col ">
                    ...
                    <p className="mb-2 text-xs sm:text-sm md:text-sm text-gray-600 text-center sm:text-left">
                        HSLines Consulting Services is a leading global consulting firm that provides high-quality, cost-effective solutions to businesses and organizations around the world.
                        Founded in 2022, HSLines Consulting Services has grown to become one of the largest and most respected consultancies in the world.
                        <br /> <br />
