                        ...
                        <div className="copyright-footer">
                                <div className="pt-3 pb-3">
                                    <div className="row flex-row-reverse justify-content-between">
                                        <div className="col-lg-12 col-md-12 text-lg-center text-md-center text-center"> <span className="copyright">Copyright 2022 <a href="index.html">HSLine</a> All Rights Reserved.</span> </div>
                                    </div>
                                </div>
                            </div>
                    </footer>
